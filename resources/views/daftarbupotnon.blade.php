...
<head>
  ...
  <title>Daftar Bukti Potong PPh Non Residen</title>
  <style>
    *{
                ...
                <table class="table w-100 table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <th scope="row">{{ $data['masa_pajak'] }}-{{ $data['tahun_pajak'] }}</th>
                      ...
                      <a href="{{url('/hapus_pphnon/'.$data['id'])}}">
