  ...
  <div class="container">
    ...
    <p class="card-secondary"style="margin-left:13%; font-weight: bold; color:red;">Anda akan buat SPT Baru 2022/02 revisi ke-0?</p>
              ...
              <div class="d-grid gap-4 d-md-flex justify-content-md-end">
                  ...
                  <a type="button" class="button button1" style="margin-right:54%" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">
                      Oke</a>           
                    </div>
          </div>
        </div>
      ...
      <div class="card-header bg-transparent border-light" style="margin-left:38%;">
    <img src="data:image/png;base64,">
  </div>
    <div class="card-body text-dark">
    <h5 class="card-title"style="margin-left:40%;font-weight: bold;">Sukses</h5>
      <p class="card-secondary" style="margin-left:22%; font-weight: bold; color:blue;">Berhasil Mengirimkan Bukti Potong</p>
              <div class="row" style="padding-left: 45%; padding-right:45%;">
              <div class="col">
              <div class="d-grid gap-4 d-md-flex justify-content-md-end">
                  <a href= "{{url('/pajakpenghasilan')}}" style="background-color: rgb(255, 157, 49); color:white;" class="btn btn me-md-2"type="button">Oke</a>
            </div>
          </div>
        </div>
      </div>
