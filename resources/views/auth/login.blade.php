            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <form method="POST" action="{{ route('login.custom') }}">
                    ...
                    <div class="form-group mb-3">
                        <input type="text"  placeholder="Masukkan NPWP" id="email" class="form-control" name="email" required
                            autofocus>
                        @if ($errors->has('email'))
                    ...
                    <div class="form-group mb-3">
                        <input type="password" placeholder="Masukkan Password" id="password" class="form-control" name="password" required>
