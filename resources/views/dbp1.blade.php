          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-body">
                ...
                style="width: 25px; margin: 0px 0px 0px 180px">
  ...
  <table>
    <thead>    
      <tr>
        ...
        <td><button style="color: black; 8px 20px; text-align: center;" class="nav-link active" id="nav-dbp1-tab" data-bs-toggle="tab" data-bs-target="#nav-dbp1" type="button" role="tab" aria-controls="nav-dbp1" aria-selected="true">Lampiran DBP Bagian 1</button></td>
        <td><a href="dbp"><button style="color:grey; padding: 8px 20px; text-align: center;" class="nav-link" id="nav-bagian2-tab" data-bs-toggle="tab" data-bs-target="#nav-dbp2" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Lampiran DBP Bagian 2</button></a></td>
